...
_CONFIGS = [
    ...
    # Stack Bowls Stage3 no-fusion ablation: initialize from the same Stage2 best checkpoint as
    # late-xattn, keep KeyState heads for adaptive chunking, but do not feed KeyState memory into
    # action generation. This isolates whether late cross-attention itself helps or hurts rollout.
    TrainConfig(
        name="pi0_base_aloha_robotwin_stack_bowls_three_keystate_stage3_pred_no_fusion_lora",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            use_checkpoint_head=True,
            use_phase_head=True,
            use_z_entry_descriptor=True,
            use_keystate_fusion=False,
            keystate_fusion_mode="none",
            z_entry_descriptor_dim=64,
            lambda_type=0.1,
            lambda_h=0.1,
            lambda_ph=0.1,
    ...
    # BEGIN AUTO BEAT_BLOCK_HAMMER CONFIGS
    TrainConfig(
        name="pi0_base_aloha_robotwin_beat_block_hammer_posthit_lora",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAlohaDataConfig(
            repo_id="beat_block_hammer_demo_clean_50_posthit_keystate_stage1",
            adapt_to_pi=False,
    ...
    TrainConfig(
        name="pi0_base_aloha_robotwin_beat_block_hammer_posthit_keystate_lora",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            use_checkpoint_head=True,
        ...
        freeze_filter=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora").get_freeze_filter(),
        batch_size=32,
        weight_loader=weight_loaders.CheckpointWeightLoader("s3://openpi-assets/checkpoints/pi0_base/params", missing_regex=".*(lora|ks_).*"),
        num_train_steps=30000,
        fsdp_devices=1,
    ),
    TrainConfig(
        name="pi0_base_aloha_robotwin_beat_block_hammer_posthit_keystate_stage2_lora",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            use_checkpoint_head=True,
            ...
            lambda_ph=0.1,
            lambda_z_entry_descriptor=0.1,
            lambda_keypose_entry_abs=0.1,
            horizon_bin0_weight=1.0,
            horizon_bin1_weight=1.10,
        ),
        data=KeyStateAlohaDataConfig(
            repo_id="beat_block_hammer_demo_clean_50_posthit_keystate_stage2_actionexpert",
            adapt_to_pi=False,
            repack_transforms=_transforms.Group(inputs=[_transforms.RepackTransform({
                "images": {
                    "cam_high": "observation.images.cam_high",
                ...
                "keystate": {
                    ...
                    "semantic_phase": "observation.keystate.semantic_phase",
                    "z_entry_descriptor": "observation.keystate.z_entry_descriptor",
                    "keypose_entry_abs": "observation.keystate.keypose_entry_abs",
                },
            })]),
            base_config=DataConfig(local_files_only=True, prompt_from_task=True),
        ),
        freeze_filter=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora").get_freeze_filter(),
        batch_size=32,
        weight_loader=weight_loaders.CheckpointWeightLoader("./checkpoints/openpi/openpi-assets/checkpoints/keystate/pi0_base_aloha_robotwin_beat_block_hammer_posthit_keystate_lora/beat_block_hammer_50_posthit_stage1_lora_15000_official/5000/params", missing_regex=".*(ks_z_entry_descriptor_head|ks_keypose_entry_abs_head).*"),
        num_train_steps=30000,
        fsdp_devices=1,
    ),
    TrainConfig(
        name="pi0_base_aloha_robotwin_beat_block_hammer_posthit_keystate_stage3_pred_late_xattn_lora",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            use_checkpoint_head=True,
        ...
        freeze_filter=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora").get_freeze_filter(),
        batch_size=32,
        weight_loader=weight_loaders.CheckpointWeightLoader("./checkpoints/openpi/openpi-assets/checkpoints/keystate_stage2/pi0_base_aloha_robotwin_beat_block_hammer_posthit_keystate_stage2_lora/beat_block_hammer_50_posthit_stage2_actionexpert_from_stage1best5000_lora_15000_official/5000/params", missing_regex=".*(ks_keypose_entry_abs_head|ks_type_embed|ks_horizon_embed|ks_phase_proj|ks_z_entry_proj|ks_action_ln|ks_memory_ln|ks_late_xattn|ks_late_xattn_alpha).*"),
        num_train_steps=30000,
        fsdp_devices=1,
    ),
    TrainConfig(
        name="pi0_base_aloha_robotwin_beat_block_hammer_posthit_keystate_stage3_pred_late_xattn_no_keypose_lora",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            use_checkpoint_head=True,
        ...
        freeze_filter=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora").get_freeze_filter(),
        batch_size=32,
        weight_loader=weight_loaders.CheckpointWeightLoader("./checkpoints/openpi/openpi-assets/checkpoints/keystate_stage2/pi0_base_aloha_robotwin_beat_block_hammer_posthit_keystate_stage2_lora/beat_block_hammer_50_posthit_stage2_actionexpert_from_stage1best5000_lora_15000_official/5000/params", missing_regex=".*(ks_type_embed|ks_horizon_embed|ks_phase_proj|ks_z_entry_proj|ks_action_ln|ks_memory_ln|ks_late_xattn|ks_late_xattn_alpha).*"),
        num_train_steps=30000,
        fsdp_devices=1,
    ),
    # END AUTO BEAT_BLOCK_HAMMER CONFIGS
